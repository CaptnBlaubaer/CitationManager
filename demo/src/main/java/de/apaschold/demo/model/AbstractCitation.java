...
public abstract class AbstractCitation {
    ...
    public AbstractCitation(int id, CitationType type, String title, String author, String journal, int year, String doi, String pdfFilePaths) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        AbstractCitation citation = (AbstractCitation) obj;
